...
public class Server285_ReadRFID {
    ...
    public Server285_ReadRFID(String host, int port, RouterResponseListener routerResponseListener) {
        try {
    ...
    private void setup() {
        ...
        asyncReadRFidServer.listen(host, port, new ListenCallback() {
            ...
            public void onAccepted(final AsyncSocket socketReadTXn) {
                ...
                Server285_ReadRFID.socketReadRFid = socketReadTXn;
...
//               send285RFIDCommand("#*SP21"); // Open port Read RFID Data
            ...
            public void onListening(AsyncServerSocket socketReadTXn) {
                System.out.println("[Server ReadRFid] Server started listening for connections");
            }
    ...
    private void handleAccept(final AsyncSocket socketReadRfid) {
        ...
        socketReadRfid.setDataCallback(new DataCallback() {
            ...
            public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
                ...
                if (recive != null) {
                    if (convertASCIItoHEX(recive).contains("5502520940")) {
                        routerResponseListener.OnRfIdReceived(convertASCIItoHEX(recive));
                        Log.e("kamalRfidR",recive);
                    }
                    else{
                        routerResponseListener.OnRfIdReceived(convertASCIItoHEX(recive));
                        Log.e("kamalRfidR","error"+recive);
                    }
