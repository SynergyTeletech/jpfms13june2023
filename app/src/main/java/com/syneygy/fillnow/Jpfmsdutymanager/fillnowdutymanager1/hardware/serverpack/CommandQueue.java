...
//import static com.syneygy.fillnow.dutymanager.fillnowdutymanager.activity.FreshDispenserUnitActivity.tvCommandExecutionTxt;
...
public class CommandQueue {
    ...
    public CommandQueue(String[] commandsList, OnAllCommandCompleted onAllCommandCompleted) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Server485.getSocket().setDataCallback(new DataCallback() {
                ...
                public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
                    ...
                    Log.e("ResponseHexK",encodeHexString(byteData)+commandsList.toString());
