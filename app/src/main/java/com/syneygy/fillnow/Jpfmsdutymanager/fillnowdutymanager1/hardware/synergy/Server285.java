...
public class Server285 {
    ...
    public Server285(String host, int port, RouterResponseListener routerResponseListener) {
        Log.e("kamalk",host);
        try {
    ...
    private void setup() {
        ...
        asyncServer.listen(host, port, new ListenCallback() {
            ...
            public void onCompleted(Exception ex) {
                if (ex != null) {
                    Log.e("ExLOc",ex.getLocalizedMessage());
